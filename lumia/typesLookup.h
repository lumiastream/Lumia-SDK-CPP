...
static std::map<std::string, int> types_values_str_LumiaSDKCommandTypes = {
    {"alert", 1},
    {"midi", 2},
    {"osc", 3},
    {"artnet", 4},
...
static std::map<std::string, int> types_values_str_LumiaSDKAlertValues = {
    {"twitch-follower", 16},
...
static std::map<std::string, int> types_values_str_LumiaSdkEventTypes = {
    {"states", 47},
    {"chat", 48},
    {"command", 49},
    {"twitch_point", 50},
...
static std::map<std::string, int> types_values_str_Platforms = {
    {"twitch", 111},
    {"youtube", 112},
    {"facebook", 113},
    {"trovo", 114},
...
static std::map<std::string, int> types_values_str_LightBrands = {
...
static std::map<std::string, int> types_values_str_EventOrigins = {
